...
HLS_SOURCES = ../../../../testbench.cpp ../../../../hash_round.cpp
...
$(ObjDir)/hash_round.o: ../../../../hash_round.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../hash_round.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/hash_round.d
