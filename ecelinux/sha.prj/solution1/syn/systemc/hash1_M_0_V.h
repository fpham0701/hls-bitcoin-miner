...
#ifndef _hash1_M_0_V_H_
#define _hash1_M_0_V_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "hash1_M_0_V_memcore.h"

SC_MODULE(hash1_M_0_V) {
...
protected:
    ...
    hash1_M_0_V_memcore* hash1_M_0_V_memcore_U;
...
public:
    ~hash1_M_0_V();
    SC_CTOR(hash1_M_0_V) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        hash1_M_0_V_memcore_U = new hash1_M_0_V_memcore("hash1_M_0_V_memcore_U");
        hash1_M_0_V_memcore_U->clk      ( clk );
        hash1_M_0_V_memcore_U->reset    ( reset );
        hash1_M_0_V_memcore_U->ce0      ( i_ce0 );
        hash1_M_0_V_memcore_U->we0      ( i_we0 );
        hash1_M_0_V_memcore_U->address0 ( memcore_iaddr );
        hash1_M_0_V_memcore_U->d0       ( i_d0 );
        hash1_M_0_V_memcore_U->q0       ( i_q0 );

        hash1_M_0_V_memcore_U->ce1      ( t_ce0 );
        hash1_M_0_V_memcore_U->we1      ( t_we0 );
        hash1_M_0_V_memcore_U->address1 ( memcore_taddr );
        hash1_M_0_V_memcore_U->d1       ( t_d0 );
        hash1_M_0_V_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "hash1_M_0_V.trace");
            // ports
