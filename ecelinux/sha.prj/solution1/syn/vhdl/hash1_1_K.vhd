...
architecture rtl of hash1_1_K_rom is 
...
architecture arch of hash1_1_K is
    component hash1_1_K_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    hash1_1_K_rom_U :  component hash1_1_K_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
