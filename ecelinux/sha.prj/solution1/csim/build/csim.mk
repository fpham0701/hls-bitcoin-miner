...
HLS_SOURCES = ../../../../main_tb.cpp ../../../../dut.cpp ../../../../sha256.cpp ../../../../util.cpp ../../../../miner.cpp
...
$(ObjDir)/sha256.o: ../../../../sha256.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../sha256.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/sha256.d

$(ObjDir)/util.o: ../../../../util.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../util.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/util.d

$(ObjDir)/miner.o: ../../../../miner.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../miner.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/miner.d
