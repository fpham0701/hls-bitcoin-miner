...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("strm_out_V_V_din", 32, hls_out, 1, "ap_fifo", "fifo_data", 8),
	Port_Property("strm_out_V_V_full_n", 1, hls_in, 1, "ap_fifo", "fifo_status", 8),
	Port_Property("strm_out_V_V_write", 1, hls_out, 1, "ap_fifo", "fifo_update", 8),
};
