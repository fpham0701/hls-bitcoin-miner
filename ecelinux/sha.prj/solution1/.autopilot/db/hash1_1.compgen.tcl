...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { outputlocation_V_address0 { O 3 vector } outputlocation_V_ce0 { O 1 bit } outputlocation_V_we0 { O 1 bit } outputlocation_V_d0 { O 32 vector } } \
} "
} else {
