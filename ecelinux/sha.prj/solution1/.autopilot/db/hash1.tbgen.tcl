...
set C_modelArgList {
	{ input_V int 32 regular {array 8 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ input_V_address0 sc_out sc_lv 3 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "input_V", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "544", "Max" : "608"}
	, {"Name" : "Interval", "Min" : "544", "Max" : "608"}
]}
...
set Spec2ImplPortList { 
	input_V { ap_memory {  { input_V_address0 mem_address 1 3 }  { input_V_ce0 mem_ce 1 1 }  { input_V_q0 mem_dout 0 32 } } }
