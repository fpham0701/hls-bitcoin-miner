...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hash1.autotvin.dat"
	set constFileTvOut       "hash1.autotvout.dat"
	set constFileHdlTvIn     "hash1.autohdltvin.dat"
	set constFileHdlTvOut    "hash1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
