...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hash1.autotvin_input_V.dat"
         "c.hash1.autotvin_bitlength.dat"
         "c.hash1.autotvin_outputlocation_V.dat"
         "c.hash1.autotvout_outputlocation_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hash1.autotvout_outputlocation_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
