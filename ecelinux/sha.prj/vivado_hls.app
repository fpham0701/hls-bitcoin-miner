<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="sha.prj" top="hash1">
    <Simulation argv="">
    ...
    <libraryFlag/>
    <files>
        <file name="../../main_tb.cpp" sc="0" tb="1" cflags=" -std=c++11 -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        <file name="dut.cpp" sc="0" tb="false" cflags="-std=c++11" csimflags="" blackbox="false"/>
