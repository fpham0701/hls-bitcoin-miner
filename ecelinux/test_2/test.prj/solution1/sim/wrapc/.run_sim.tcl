...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "prepareMessage.autotvin.dat"
	set constFileTvOut       "prepareMessage.autotvout.dat"
	set constFileHdlTvIn     "prepareMessage.autohdltvin.dat"
	set constFileHdlTvOut    "prepareMessage.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
