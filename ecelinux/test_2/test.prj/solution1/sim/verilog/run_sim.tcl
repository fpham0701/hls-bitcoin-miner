...
if {[file isfile prepareMessage.autotvin.dat]} {
	file delete -force prepareMessage.autotvin.dat
}

if {[file isfile prepareMessage.autotvout.dat]} {
	file delete -force prepareMessage.autotvout.dat
}
